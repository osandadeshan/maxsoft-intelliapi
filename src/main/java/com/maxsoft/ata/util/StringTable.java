 ...
 * To change this license header, choose License com.maxsoft.ata.request.Headers in Project Properties.
...
public final class StringTable {
    ...
    public StringTable(Board board, int tableWidth, List<String> headersList, List<List<String>> rowsList) {
        this.board = board;
        if (tableWidth <= 0) {
            throw new RuntimeException("com.maxsoft.ata.util.Board width must be large than zero. " + tableWidth + " given.");
        } else {
