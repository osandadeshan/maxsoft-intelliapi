...
* And the user set the query parameters using data stores as follows
    |Query Name     |Is Data Store Used?|Data Store Type|Data Store Variable Name    |Query Value    |
    |---------------|-------------------|---------------|----------------------------|---------------|
    |deckId         |y                  |spec           |myDeckIdWith8Questions      |N/A            |
* When the user invokes the API
* Then the status code for the request is "200"
* And the JSON Path Assertions for the response should be equal to the values inside the data stores
     |JSON Path                           |Is Data Store Used?|Data Store Type|Data Store Variable Name     |Value                                              |
...
* And save the JSON Path values in the response inside the data stores
    ...
    |---------------|---------------------|-----------------------|
    |spec           |fileUploadDeckId     |$.id                   |
* Given that a user needs to invoke "Create Cards in Aggregation Service using Google Drive File Upload"
* And the user set the request authentication configurations as follows
     |Configuration                                                     |Configuration Value            |
     |------------------------------------------------------------------|-------------------------------|
     |Is authentication required?                                       |Yes                            |
...
* And the user set the request attributes using data stores as follows
     ...
     |#deckId                         |y                  |spec           |fileUploadDeckId        |                                                         |
     |"#examDate"                     |n                  |               |                        |""                                                       |
     |#isExpert                       |n                  |               |                        |false                                                    |
     |#fileId                         |n                  |               |                        |1-hn6kuN0Qn6fUg_ESGI_SBUx28pwtfvJ                        |
     |#title                          |n                  |               |                        |Demo file upload                                         |
     |#type                           |n                  |               |                        |GoogleDrive                                              |
     |#userId                         |n                  |               |                        |osan                                                     |
* When the user invokes the API
* Then the status code for the request is "200"
...
Get questions count using a file upload
---------------------------------------
* Given that a user needs to invoke "Get Questions Count using Aggregation Service"
* And the user set the request authentication configurations as follows
     |Configuration                                                     |Configuration Value            |
...
* And the user set the query parameters using data stores as follows
    |Query Name     |Is Data Store Used?|Data Store Type|Data Store Variable Name    |Query Value    |
    |---------------|-------------------|---------------|----------------------------|---------------|
    |deckId         |y                  |spec           |fileUploadDeckId            |N/A            |
* When the user invokes the API
* Then the status code for the request is "200"
* And the JSON Path Assertions for the response should be equal to the values inside the data stores
     |JSON Path                           |Is Data Store Used?|Data Store Type|Data Store Variable Name     |Value                                              |
