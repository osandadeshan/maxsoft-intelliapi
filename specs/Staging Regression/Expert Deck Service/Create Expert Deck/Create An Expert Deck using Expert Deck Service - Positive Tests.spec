Create An Expert Deck using Expert Deck Service - Positive Tests Specification
==============================================================================
...
tags: create_expert_deck, create_expert_deck-positive_tests, positive
...
Create an Expert Deck only using deck title and userId
------------------------------------------------------
* Given that a user needs to invoke "Create An Expert Deck using Expert Deck Service"
* And the user set the request authentication configurations as follows
     |Configuration                                                     |Configuration Value            |
...
Delete firstly created expert deck
----------------------------------
...
* And the user set the path parameters using data stores as follows
    ...
    |---------------|-------------------|---------------|------------------------|---------------|
    |expertDeckId   |y                  |spec           |deckId1                 |N/A            |
* When the user invokes the API
* Then the status code for the request is "204"



Delete secondly created expert deck
-----------------------------------
* Given that a user needs to invoke "Delete Expert Deck by ID using Expert Deck Service"
* And the user set the request authentication configurations as follows
     |Configuration                                                     |Configuration Value            |
...
* And the user set the path parameters using data stores as follows
    |Path Name      |Is Data Store Used?|Data Store Type|Data Store Variable Name|Path Value     |
    |---------------|-------------------|---------------|------------------------|---------------|
    |expertDeckId   |y                  |spec           |deckId2                 |N/A            |
* When the user invokes the API
* Then the status code for the request is "204"