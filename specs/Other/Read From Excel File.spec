...
## Invoke Auth API using the test data in excel file

* And the user saves test data inside excel file into data stores 

   |DataStore Type|Variable Name|Excel Sheet Name|Key Name|
   |--------------|-------------|----------------|--------|
   |Scenario      |varUsername  |Auth_Test_Data  |username|
   |Specification |varPassword  |Auth_Test_Data  |password|
...
* And the user set the request attributes using data stores as follows 
   ...
   |--------------------------------|-------------------|---------------|------------------------|-------------------------|
   |#username                       |y                  |Scenario       |varUsername             |                         |
   |#password                       |y                  |Specification  |varPassword             |                         |
