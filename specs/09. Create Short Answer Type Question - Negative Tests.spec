Create Short Answer Type Question - Negative Test Specification
===============================================================
...
* And the JSON Path Assertions for the response should be equal to the following
     ...
     |$.fieldErrors[0].message                  |'value' Cannot be empty                                  |



Create a question using an empty value as the iscorrectAnswerCaseSensitive
--------------------------------------------------------------------------
* And the user set the request authentication configurations as follows
     |Configuration Property Name       |Configuration Property Value   |
     |----------------------------------|-------------------------------|
...
* And the JSON Path Assertions for the response should be equal to the following
     |JSON Path                                 |Value                                                                                                                            |
     |------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
     |$.message                                 |Unexpected character ('}' (code 125)): expected a value\n at [Source: java.io.PushbackInputStream@232714b3; line: 32, column: 10]|
     |$.description                             |null                                                                                                                             |
     |$.fieldErrors                             |null                                                                                                                             |
